...
//	double smooth = 3.24;
	...
	FFT(ar512, FFT_N_512, retr512, reti512);
	...
	iFFT(ar512, ai512, FFT_N_512, retr512);
...
//	printd(ar, FFT_N_1024);
	...
	/* forward FFT */
	int ret = FFT(ar, FFT_N_1024, retr, reti);
...
//	print(retr, reti, FFT_N_1024);
	...
	iFFT(ar, ai, FFT_N_1024, retr);
//	print(retr, reti, FFT_N_1024);

	clock_t t1 = clock();
	for(int lpct    = 0; lpct < 100000; lpct++) {
		HigashiWindow(ar[0], ar, FFT_N_1024);
		FFT(ar, FFT_N_1024, retr, reti);
		execFilter(retr, reti, FFT_N_1024, filterary);
		iFFT(ar, ai, FFT_N_1024, retr);
	}
	clock_t t2 = clock();	
